<%-- 
    Document   : sidebar
    Created on : May 7, 2017, 5:24:29 PM
        ...
        <!-- Optionally, you can add icons to the links -->
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="AppReq.jsp">Approve Requests</a></li>
            <li><a href="PenReq.jsp">Pending Requests</a></li>
          </ul>
        </li>    
        <li><a href="SchedMngmnt.jsp"><i class="fa fa-link"></i> <span>Schedule Management</span></a></li>    
        </li>
